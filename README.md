...
/**
 *
 * @author hafizhohviarma
 */
public class HafizhohViarma { //<- Ini adalah blok class dengan nama HafizhohViarma 
    ...
    // Method main() memiliki parameter args[]. Parameter ini nanti akan menyimpan sebuah nilai dari argumen di command line.
        System.out.println("Welcome to Java Programming Hafizhoh Viarma!!!"); // Ini adalah fungsi untuk menampilkan teks ke layar monitor.  
    }
}
